...
public class MessageConstant {
    ...
    public static final String LOGIN_FAIL = "登录失败";  // 个人添加
    public static final String DATE_ERROR = "日期错误";  // 个人添加
    ...
    // 个人添加
    public static final String ADD_PERMISSION_SUCCESS = "新增权限项成功"; // 个人添加
    public static final String ADD_PERMISSION_FAIL = "新增权限项失败"; // 个人添加
    public static final String QUERY_PERMISSION_SUCCESS = "查询权限项成功"; // 个人添加
    public static final String QUERY_PERMISSION_FAIL = "查询权限项失败"; // 个人添加
    public static final String DELETE_PERMISSION_SUCCESS = "删除权限项成功"; // 个人添加
    public static final String DELETE_PERMISSION_FAIL = "删除权限项失败"; // 个人添加
    public static final String EDIT_PERMISSION_SUCCESS = "编辑权限项成功"; // 个人添加
    public static final String EDIT_PERMISSION_FAIL = "编辑权限项失败"; // 个人添加
